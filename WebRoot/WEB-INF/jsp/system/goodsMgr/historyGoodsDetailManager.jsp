                    ...
                    <div class="task-widget">
                        <div class="task-widget-body clearfix">
                            ...
                            <div class="widget-detail">
                                <small class="text-upper text-muted block font-sm">当期增长</small>
                        ...
                        <div class="task-widget-statatistic">
                            <ul class="clearfix">
                                <li class="bg-grey border-success">
                                    <div class="text-muted text-upper font-sm">最后一次更新时间</div>
                                    ${detail.edit_time}
                                </li>
                                <li class="bg-grey border-danger">
                                    <div class="text-muted text-upper font-sm">当期总销量</div>
                                    ${detail.sell_num}
                                </li>
...
<script type="application/javascript">
    ...
    function Back() {
        window.location.href="<%=basePath%>Basic/GoodsMgr/HistoryGoodsManager";
    }
