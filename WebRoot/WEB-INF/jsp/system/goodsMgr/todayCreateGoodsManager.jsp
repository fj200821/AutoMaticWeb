...
<div class="wrapper preload">
    <!-- 左侧菜单-->
     <%
        ...
        request.setAttribute("MenuCode", "TodayCreateGoodsManager");
      %>
            ...
            columns: [{
                ...
                formatter:function(value,row,index){
                    ...
                    var detail = '<a type="button" class="btn btn-primary " ' +
                        'href="<%=basePath%>Basic/GoodsMgr/ToDayCreateGoodsDetailManager?goodsId='+ row.id + '">' +
                        '详情'+
                        '</a>';
                        //synchro+'   '+
