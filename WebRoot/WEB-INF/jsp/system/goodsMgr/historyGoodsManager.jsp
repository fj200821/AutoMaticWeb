...
<div class="wrapper preload">
    <!-- 左侧菜单-->
     <%
        ...
        request.setAttribute("MenuCode", "HistoryGoodsManager");
      %>
                                    ...
                                    <form class="form-horizontal no-margin required-validate" id="queryForm">
                                        ...
                                        <div class="row" style="margin-left: 20px;">
                                            <div class="form-group">
                                                <div class="col-md-2">
                                                    <label class="control-label">往期</label>
                                                    <select id="tmpTable" name="tmpTable" class="form-control input-sm">
                                                    </select>
                                                </div>
                                                <div class="col-md-2">
...
<script type="application/javascript">
    ...
    $(function () {
        loadSelectWithParaAndNotEmpty('tmpTable',{pcode:'tmpTableName'},'code','name','<%=basePath%>Basic/SystemDict/queryDictCodeByPCode');
        $("#tmpTable ").get(0).selectedIndex=1;
    ...
    function confirm3() {
        ...
        form.attr('action', '<%=basePath%>Basic/GoodsMgr/GoodsManager/exportData3');
        var input3 = $('<input>');
        input3.attr('type', 'hidden');
        input3.attr('name', 'tmp_table');
        input3.attr('value', postData['tmpTable']);
        var input4 = $('<input>');
    ...
    function initTable(postData) {
        var queryParams = function (params) {
            ...
            var temp = {
                ...
                tmp_table:postData['tmpTable']
            };
            return temp;
        };
        $('#baseTable').bootstrapTable('destroy').bootstrapTable({
            url:"<%=basePath%>Basic/GoodsMgr/GoodsManager/queryHistoryGoods",
            method:'POST',
            striped:true,
            cache:false,
            toolbar: '#toolbar',
            ...
            columns: [{
                ...
                field: 'tmp',title: 'tmp',visible:false
            },{
                ...
                field: 'sell_num',title: '当期总销量',align:'center',sortable : true
            },{
                field: 'add_num',title: '当前增量',align:'center',sortable : true
            },{
                title: '最后一次更新时间', align:'center',sortable : true,field:'edit_time',
                formatter:function(value,row,index){
                    var t = new Date();
                ...
                formatter:function(value,row,index){
                    ...
                    var detail = '<a type="button" class="btn btn-primary " ' +
                        'href="<%=basePath%>Basic/GoodsMgr/HistoryGoodsDetailManager?goodsId='+ row.id + '&tmp='+row.tmp+'">' +
                        '详情'+
                        '</a>';
