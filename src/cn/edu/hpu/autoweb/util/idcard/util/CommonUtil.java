package cn.edu.hpu.autoweb.util.idcard.util;

import cn.edu.hpu.autoweb.util.idcard.Client;
import cn.edu.hpu.autoweb.util.idcard.Request;
import cn.edu.hpu.autoweb.util.idcard.constant.Constants;
import cn.edu.hpu.autoweb.util.idcard.constant.ContentType;
import cn.edu.hpu.autoweb.util.idcard.constant.HttpHeader;
import cn.edu.hpu.autoweb.util.idcard.constant.HttpSchema;
import cn.edu.hpu.autoweb.util.idcard.enums.Method;
...
public class CommonUtil {
     ...
     * @throws Exception
     */
    public HttpResponse HttpsPostString(String body) throws Exception {;
        Map<String, String> headers = new HashMap<String, String>();
        //（可选）响应内容序列化格式,默认application/json,目前仅支持application/json
        headers.put(HttpHeader.HTTP_HEADER_ACCEPT, "application/json");
        //（可选）Body MD5,服务端会校验Body内容是否被篡改,建议Body非Form表单时添加此Header
...
//        print(response);
     ...
     * @throws Exception
     */
    public HttpResponse sendPostRequestWithBody()throws Exception{
