...
public class StringUtils {
   ...
   public static Map toLowerMap(Map oldmap) 
	...
	public static String getTempTableName(Date date){
		return "tmp_"+ DateUtils.formatDate(date,DateUtils.PATTERN_DATE_YYYYMMDD);
	}

	public static String getTempTableName(){
		return "tmp_"+ DateUtils.formatDate(new Date(),DateUtils.PATTERN_DATE_YYYYMMDD);
	}
